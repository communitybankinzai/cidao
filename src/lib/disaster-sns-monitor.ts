...
// 2026-09-21：「佐山の交差点先で水が溢れて通行不可」（Threads）が「冠水」「通行止」を含まず落ちていたため、
// 通行不可・通行不能・溢れ・あふれ・マンホール を足した（場所語との両方が必要なので市外の誤検出は増えにくい）
const DISASTER_SIGNAL = /冠水|浸水|洪水|氾濫|越水|大雨|豪雨|線状降水帯|通行止|通行不可|通行不能|通れな|通行でき|溢れ|あふれ|マンホール|道路.{0,8}水|アンダーパス|土砂|土石流|崖崩|がけ崩|倒木|停電|断水|救助|取り残|避難|地震|揺れ|震度|倒壊|液状化|警報|注意報|河川.{0,8}(増水|危険)|水没|水浸し|冠水注意|池のよう|川のよう|濁り水|信号.{0,4}(消え|停止)|電柱.{0,4}(倒|折)|屋根.{0,6}(飛|剥が|壊)|瓦.{0,4}(飛|落)|看板.{0,4}(倒|飛)|土のう|土嚢/
